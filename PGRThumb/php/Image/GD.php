<?php
include_once '/home/user/tools/PicturePlatform/src/pgrfilemanager/php/utils.php';
...
class PGRThumb_Image_GD extends PGRThumb_Image
{
    ...
    public function saveImage($file, $quality = 100, $type = null)
    {
        ...
        switch($type) {
            case 'GIF':
                return imagegif($this->_processedImage, PGRFileManagerUtils::charchangerev($file));
            case 'JPEG':
                return imagejpeg($this->_processedImage, PGRFileManagerUtils::charchangerev($file), $quality);
            case 'PNG':
                return imagepng($this->_processedImage, PGRFileManagerUtils::charchangerev($file), $quality/100);
            default:
                return false;
        }        
    }
